(function () {
    ...
    retryWhileError(function () {
        ...
        NAtask.setCorrespondenceTask({
            ...
            right: solutions,
            postText: 'Пользуясь графиком, поставьте в соответствие каждому интервалу времени характеристику пульса гимнаста на этом интервале.<br/><br/> ВРЕМЕННЫЕ ответы <br/>' +
                listView.join('<br/>'),
        });
