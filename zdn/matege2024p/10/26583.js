(function() {
	...
	retryWhileError(function() {
		...
		let key = "26583";
		let preference = ['speed_first', 'speed_second'];
		...
		let the_vehicleRacingOnRoad = sklonlxkand([
			"автомобиль", "мотоцикл", "велосипед", "электросамокат", "гироскутер", "мотоциклист", "велосипедист", "гонщик",
			"грузовик", "автомобилист"
		].iz()); //
		let the_orderToFind = decor.orderToFind.iz(); // ["найдите","определите","вычислите"]

		NAtask.setTask({
			text: 'Два ' + the_vehicleRacingOnRoad.re + ' одновременно отправились в ' + S + '-километровый пробег. ' +
