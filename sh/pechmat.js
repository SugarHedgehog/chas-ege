...
function getAnswersSubtableLaTeX(cellsInFirstRow, answersParsedToTeX) {
	var hline = "\n\n\\hline\n";
	return (
		'\\begin{multicols}{8}\n' +//TODO: надо как-то узнать количество всех заданий и сколько оно делится на 50(тк 50 ответов обычно влазит на страницу(вообще в идеале 47)) и только l поставить
...
var preambulaForAnsw = ['\\documentclass[a6paper]{article}\n\\usepackage{dashbox}\n\\usepackage[T2A]{fontenc}\n\\usepackage[utf8]{inputenc}\n\\usepackage[english,russian]{babel}\n\n\\usepackage{egetask_alternative}\n\n\\usepackage{multicol}']
