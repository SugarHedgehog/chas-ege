(function () {
    ...
    retryWhileError(function () {
        ...
        NAtask.setCorrespondenceTask({
            ...
            right: solutions,
            postText: 'Пользуясь рисунком, поставьте в соответствие каждому из указанных периодов времени характеристику рождаемости в этот период.<br/><br/> ВРЕМЕННЫЕ ответы <br/>' +
                listView.join('<br/>'),
        });
