(function() {
	...
	retryWhileError(function() {
		let key = "525375";
		let preference = ['boat_speed', 'river_speed'];
		...
		NAtask.setTask({
			text: '' + the_activeFloatingVehicle.ie.toZagl() + ' в ' + a + ':00 вышла из ' + the_humanSettlementDestination
				.re +
			...
			questions: [
				[{
					...
					text: ' (в км/ч) скорость течения реки, если известно, что собственная скорость ' +
