(function() {
	...
	retryWhileError(function() {
		...
		let key = "99592";
		let preference = ['time_first', 'time_second'];
		...
		let the_vehicleRacingOnRoad = sklonlxkand([
			["автомобиль", "автомобилист"].iz(), ["мотоцикл", "мотоциклист"].iz(), ["велосипед", "велосипедист"].iz(),
			"электросамокат", "гироскутер", "гонщик", "грузовик"
		].iz(2));

		NAtask.setTask({
			text: ['Из ' + the_humanSettlementDestination.rm + ' A и B навстречу друг другу одновременно выехали ' +
					the_vehicleRacingOnRoad[1].ie + ' и ' + the_vehicleRacingOnRoad[0].ie,
					the_vehicleRacingOnRoad[1].ie.toZagl() + ' и ' + the_vehicleRacingOnRoad[0].ie + ' выехали одновременно из ' +
					the_humanSettlementDestination.rm + ' A и B навстречу друг другу'
				].iz() +
				...
				'Сколько ' + ['часов', 'времени'].iz() + [' затратил на ' + ['путь', 'дорогу'].iz() + ' из ' +
					...
					the_humanSettlementDestination.re + ' B в ' + the_humanSettlementDestination.ve + ' A?',
					' затратил ' + the_vehicleRacingOnRoad[0].ie + ' на ' + ['путь', 'дорогу'].iz() + ' из ' +
					the_humanSettlementDestination.re + ' B в ' + the_humanSettlementDestination.ve + ' A?',
					' ушло у ' + the_vehicleRacingOnRoad[0].re + ' на ' + ['путь', 'дорогу'].iz() + ' из ' +
					the_humanSettlementDestination.re + ' B в ' + the_humanSettlementDestination.ve + ' A?'
				][rand],
			answers: t,
			authors: ['Aisse-258'],
