...
function _getMenuModel(genJson, nastrCopy, obol) {
	...
	//Самостоятельная по производным
	var nastr_kontr_der=nastrCopy.clone();
	nastr_kontr_der.nabor={zagol:'../zdn/misc_independent_work_der/misc_independent_work_der.js'};
	...
	return {
		...
		"Тесты": {
			"По предметам": {
				"Самостоятельная по производным": obol + genJson(nastr_kontr_der),
