...
function _getMenuModel(genJson, nastrCopy, obol) {
	...
	var nastr_misc_derivative=nastrCopy.clone();
	nastr_misc_derivative.nabor={zagol:'../zdn/misc_derivative/misc_derivative.js'};
	...
	return {
		...
		"Тесты": {
			"По предметам": {
				"Производные": obol + genJson(nastr_misc_derivative),
