...
(function () {
    ...
    NAtask.setTask({
        ...
        text: 'Автоматическая линия изготавливает ' + predm.im + '. Вероятность того, что готовая ' +
            '' + predm.ie + ' неисправна, равна ' + verneispr.ts() + '. Перед упаковкой каждая ' + predm.ie + ' проходит систему' +
            ' контроля. Вероятность того, что система забракует неисправную ' + predm.ve + ', равна ' + verzabrakneispr.ts() + '. ' +
            'Вероятность того, что система по ошибке забракует исправную ' + predm.ve + ', равна ' + verzabrispr.ts() + '. ' +
