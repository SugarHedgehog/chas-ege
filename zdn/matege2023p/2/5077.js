(function() {
	...
	lx['полная площадь поверхности'] = {
		ie:'полная площадь поверхности',
		re:'полной площади поверхности',
		de:'полной площади поверхности',
		ve:'полную площадь поверхности',
		te:'полной площадью поверхности',
		pe:'полной площади поверхности',
		im:'полные площади поверхности',
		rm:'полных площадей поверхности',
		dm:'полным площадям поверхности',
		vm:'полные площади поверхности',
		tm:'полными площадями поверхности',
		pm:'полных площадях поверхности',
		rod: 1,
	};
