...
window.nabor.upak[1].main = function(){
	window.nomer = 8;
	window.nabor.preferences['8'] = ['cosA', 'findTrigValue'];
}

window.nabor.upak[2].main = function(){
	window.nomer = 649891001;
}
...
window.nabor.upak[7].main = function(){
	window.nomer = 11;
	window.nabor.preferences['11'] = ['integer', 'double_angle', 'without_tg_ctg'];
}

window.nabor.upak[8].main = function(){
	window.nomer = 2542;
	window.nabor.preferences['2542'] = ['number'];
}
...
window.nabor.upak[11].main = function(){
	window.nomer = 509271;
	window.nabor.preferences['509271'] = ['findAbscissa','withoutB','withoutC'];
}

window.nabor.upak[12].main = function(){
	window.nomer = 77467;
	window.nabor.preferences['77467'] = ['xfrac','minimum'];
}
