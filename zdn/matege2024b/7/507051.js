(function () {
    ...
    retryWhileError(function () {
        ...
        NAtask.setCorrespondenceTask({
            ...
            right: solutions,
            postText: 'Пользуясь графиком, поставьте в соответствие каждому интервалу числа оборотов в минуту характеристику крутящего момента на этом интервале.<br/><br/> ВРЕМЕННЫЕ ответы <br/>' +
                listView.join('<br/>'),
        });
