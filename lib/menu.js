...
function _getMenuModel(genJson, nastrCopy, obol) {
	...
	//Математика ЕГЭ-2026 профильный
	var nastr_matege2026p=nastrCopy.clone();
	nastr_matege2026p.nabor={zagol:'../zdn/matege2026p/matege2026p.js'};

	//Математика ЕГЭ-2026 профильный, ФИПИ
	var nastr_matege2026pf=nastrCopy.clone();
	nastr_matege2026pf.nabor={zagol:'../zdn/matege2026p/matege2026p_fipi.js'};
	...
	return {
		...
		"Тесты": {
			"По предметам": {
				"Математика: ЕГЭ-2026 (профильный)": obol + genJson(nastr_matege2026p),
				"Математика: ЕГЭ-2026 (профильный, только ФИПИ)": obol + genJson(nastr_matege2026pf),
